...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '949657126').split()]  #Admin Id
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001176901973').split()] #Movie Database Channel Id
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002134871596'))  #Log Channel Id
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002134871596'))  #Streming Log Channel Id
...
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1001622914589'))

IS_VERIFY = is_enabled('IS_VERIFY', False)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002134871596')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002134871596')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
...
URL = "https://movie-loverzz-f2c1e32890d7.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else "https://movie-loverzz-f2c1e32890d7.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://movie-loverzz-f2c1e32890d7.herokuapp.com/".format(FQDN)
else:
    URL = "https://movie-loverzz-f2c1e32890d7.herokuapp.com/".format(FQDN)
